function init_elements() {
  ...
  .then(resp => resp.json())
  .then(obj=>{
    var s  = '<div class="col-12"><div class="section-header" ><div class="sec-icon"><i class="ion ion-android-settings"></i></div><div class="sec-title">Social Media</div></div ></div > ';
    ...
    document.getElementById("cont_list").innerHTML = s;
  });
